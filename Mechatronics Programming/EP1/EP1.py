...
def main(nome):
    ...
    while interacoes<possibilidades and cl<clausulas:
        ...
        if cl==clausulas:
            ...
            retorno = "Modo BruteForce:\n" "Interações: " + str(interacoes) + "\n" + "Combinação de variavéis:\n" + var_print + "\n\n"
...
print(main(input("Nome do arquivo: ")))
'''res=open('resultado20.txt', 'w', encoding='utf-8')
total=0.0
for y in range(5):
    tim=time.clock()
    res.write("Arquivo: uf20-0"+str(y+1)+".cnf\n"+"BruteForce:\n")
    res.write(main("uf20-0"+str(y+1)+".cnf","brute"))
    ...
    tim=time.clock()
    res.write(main("uf20-0"+str(y+1)+".cnf","random"))
