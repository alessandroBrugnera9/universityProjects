...
F=zeros(0.5/dt,1);
F=[F; zeros(length(t)-0.5/dt,1)+1000]
...
saveas(figure1,'E-x(t).jpg');
saveas(figure2,'E-v(t).jpg');
saveas(figure3,'E-a(t).jpg');
saveas(figure4,'E-x(v(t)).jpg');
saveas(figure5,'E-F(t).jpg');
